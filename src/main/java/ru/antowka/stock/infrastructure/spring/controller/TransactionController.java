...
//    public @ResponseBody
//    TransactionRepresentation create(@RequestBody TransactionRepresentation command) {
//
...
//
//        for (TransactionRepresentation transactionRepresentation : transactionDeleteRq.getTransactions()) {
//            if (transactionRepresentation.getId() == null) {
//                throw new TransactionException("Wrong request for remove transaction");
//            }
//            transactions.add(transactionMapper.toEntity(transactionRepresentation));
//        }
//
